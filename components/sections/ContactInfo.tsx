    ...
    <div>
      ...
      <div className="mt-12 pt-8 border-t border-gray-200">
        ...
        <div className="flex space-x-4">
          ...
          <a href="https://www.instagram.com/kvstechflow_" className="bg-gray-100  p-3 rounded-full drop-shadow-lg  transition-all"
             target="_blank" rel="noopener noreferrer">
          ...
          <a href='https://wa.me/9571726363?text=Hello%20sir!' className="bg-gray-100  p-3 rounded-full drop-shadow-lg  transition-all"
             target="_blank" rel="noopener noreferrer">
